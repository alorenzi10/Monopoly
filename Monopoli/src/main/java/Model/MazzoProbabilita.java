...
public class MazzoProbabilita extends Mazzo { // Da controllare e ultimare azione paga case 13/11/2024
    ...
    MazzoProbabilita() {
    	...
    	// Ricezione denaro
    	cards.add(new Carta(PROBABILITA, "Maturano gli interessi della vostra assicurazione sulla vita: incassate 100€.", AZIONE_RICEVI, 100));
    	cards.add(new Carta(PROBABILITA, "La banca riconosce un errore nel vostro estratto conto: incassate 200€.", AZIONE_RICEVI, 200));
    	cards.add(new Carta(PROBABILITA, "Maturano le cedole delle vostre azioni: ricevete 100€.", AZIONE_RICEVI, 100));
    	cards.add(new Carta(PROBABILITA, "Ereditate 100€ da un lontano zio.", AZIONE_RICEVI, 100));
    	cards.add(new Carta(PROBABILITA, "Dalla vendita di uno stock di merci ricavate 50€.", AZIONE_RICEVI, 50));
    	cards.add(new Carta(PROBABILITA, "Ricevete 25€ per la vostra consulenza.", AZIONE_RICEVI, 25));
    	cards.add(new Carta(PROBABILITA, "Vi viene rimborsata la tassa sui redditi: incassate 20€.", AZIONE_RICEVI, 20));
    	cards.add(new Carta(PROBABILITA, "Avete vinto il secondo premio in un concorso di bellezza! Incassate 10€.", AZIONE_RICEVI, 10));
    	cards.add(new Carta(PROBABILITA, "È il vostro compleanno: ogni giocatore vi regala 10€.", REGALI, 10));
