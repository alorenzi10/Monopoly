...
public class MazzoImprevisti extends Mazzo { // Da controllare e ultimare azione paga case 13/11/2024
    ...
    MazzoImprevisti(){
    	...
    	cards.add(new Carta(IMPREVISTI, "Avanzate fino alla società più vicina; Se è libera potete acquistarla dalla banca; Se è posseduta da un altro giocatore lanciate i dadi e pagate al proprietario dieci volte il numero uscito sui dadi.", AZIONE_SOCIETA_VICINA)); 
    	
    	cards.add(new Carta(IMPREVISTI, "Avanzate fino alla stazione ferroviaria più vicina; Se è libera potete acquistarla dalla banca; Se è posseduta da un altro giocatore pagate al proprietario il doppio dell’affitto che gli spetta normalmente.", AZIONE_FERROVIA_VICINA));
