...
public class MazzoImprevisti extends Mazzo {
    ...
    MazzoImprevisti(){
    	...
    	cards.add(new Carta(IMPREVISTI, "Avanzate fino alla stazione ferroviaria più vicina; Se è libera potete acquistarla dalla banca; Se è posseduta da un altro giocatore pagate al proprietario il doppio dell’affitto che gli spetta normalmente.", AZIONE_VAI_AVANTI));
    	cards.add(new Carta(IMPREVISTI, "Andate fino a Largo Colombo: Se passate dal “Via!” ritirate 200€.", AZIONE_VAI_AVANTI, 200));
    	
    	cards.add(new Carta(IMPREVISTI, "Andate fino a Parco della Vittoria: Se passate dal “Via!” ritirate 200€.", AZIONE_VAI_AVANTI, 200));
    	
    	cards.add(new Carta(IMPREVISTI, "Andate alla Stazione Nord; Se passate dal “Via!” ritirate 200€.", AZIONE_VAI_AVANTI, 200));
    	cards.add(new Carta(IMPREVISTI, "Andate sino a Corso Ateneo; Se passate dal “Via!” ritirate 200€.", AZIONE_VAI_AVANTI, 200));
